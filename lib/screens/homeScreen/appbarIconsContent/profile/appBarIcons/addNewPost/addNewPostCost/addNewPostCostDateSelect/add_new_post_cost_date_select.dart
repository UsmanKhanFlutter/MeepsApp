...
class AddNewPostCostDateSelect extends StatefulWidget {
  const AddNewPostCostDateSelect({Key? key}) : super(key: key);

  @override
  _AddNewPostCostDateSelectState createState() =>
      _AddNewPostCostDateSelectState();
}

class _AddNewPostCostDateSelectState extends State<AddNewPostCostDateSelect> {
  DateTime? _startDay;
  DateTime? _endDay;
