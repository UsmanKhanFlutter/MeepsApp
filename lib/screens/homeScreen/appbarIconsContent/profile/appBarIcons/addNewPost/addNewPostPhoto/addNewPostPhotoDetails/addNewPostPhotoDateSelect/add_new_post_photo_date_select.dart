...
class AddNewPostPhotoDateSelect extends StatefulWidget {
  const AddNewPostPhotoDateSelect({Key? key}) : super(key: key);

  @override
  _AddNewPostPhotoDateSelectState createState() =>
      _AddNewPostPhotoDateSelectState();
}

class _AddNewPostPhotoDateSelectState extends State<AddNewPostPhotoDateSelect> {
  DateTime? _startDate;
  DateTime? _endDate;
                  ...
                  children: [
                    Container(
                      ...
                      child: SfDateRangePicker(
                        onSelectionChanged:
                          ...
                          setState(() {});
                          _startDate = dateRangePickerSelectionChangedArgs
                              .value.startDate;
                          _endDate =
                              dateRangePickerSelectionChangedArgs.value.endDate;
                          print(_startDate!.day.toString() +
                              '.' +
                              _startDate!.month.toString() +
                              '.' +
                              _startDate!.year.toString());
                          print(_endDate!.day.toString() +
                              '.' +
                        ...
                        // initialSelectedRanges: [PickerDateRange(_startDate, _endDay)],
                    ...
                    Neumorphic(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          selectedStartDate = _startDate!.day.toString() +
                              '.' +
                              _startDate!.month.toString() +
                              '.' +
                              _startDate!.year.toString();

                          selectedEndDate = _endDate!.day.toString() +
                              '.' +
                              _endDate!.month.toString() +
                              '.' +
                              _endDate!.year.toString();
                          ...
                          Navigator.of(context)
                              .pushReplacement(MaterialPageRoute(
                                  builder: (context) => AddNewPostPhotoDetails(
