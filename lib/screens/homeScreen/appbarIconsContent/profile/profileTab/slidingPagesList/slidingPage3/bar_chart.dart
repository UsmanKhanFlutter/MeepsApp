...
class _BarChartState extends State<BarChart> {
  List<_barData> barData = [
    _barData('Visits', '35%', Color(0xff32d5d7), 50),
    _barData('Checkouts', '20%', Color(0xff41DDDF), 30),
    _barData('Travel', '15%', Color(0xff56E4E6), 20),
    _barData('Stays', '12%', Color(0xff76E8E9), 14),
    _barData('Bookings', '8%', Color(0xff92EAEB), 10)
  ];
  @override
